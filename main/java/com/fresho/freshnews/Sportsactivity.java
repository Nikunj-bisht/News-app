...
public class Sportsactivity extends AppCompatActivity implements Customadaptor.fortransition {
...
categ = getIntent().getStringExtra("category");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(country.equals("Select country")){
                    ...
                    Toast.makeText(Sportsactivity.this,"Please select a country first",Toast.LENGTH_LONG).show();
                }
                else {
                    makerequest();
    ...
    private void makerequest() {
        ...
        final String url = "https://newsapi.org/v2/top-headlines?country=" + hashMap.get(country)+"&category="+categ +"&pageSize=60&apiKey=a17375e1fa9e429e92b26297075b5528";
...
recyclerView.removeAllViewsInLayout();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Sportsactivity.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    findViewById(R.id.po).setVisibility(View.GONE);
                    ...
                    if(n>0){
                        ...
                        Customadaptor customadaptor = new Customadaptor(Sportsactivity.this,data,Sportsactivity.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                update();
                Toast.makeText(Sportsactivity.this,"Error",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void opensite(String url) {
        ...
        Intent intent = new Intent(Sportsactivity.this,Weber.class);
    ...
    public void opencurrent(String url, int pos) {
        ...
        Intent intent = new Intent(Sportsactivity.this,Detailnews.class);
